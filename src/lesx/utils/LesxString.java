...
public class LesxString {
   ...
   * Scene Controller
   */
  public static final String MAIN_SCENE_PATH = "/main/MainFXML.fxml";
  public static final String MAINPAGE_PATH = "/lesx/ui/mainpage/LesxMainpageFXML.fxml";
  public static final String COSTUMER_DIALOG_PATH = "/lesx/ui/costumer/dialog/LesxCostumerDialogPaneFXML.fxml";
   ...
   * Property Names
   */
  public static final String PROPERTY_NAME = "Nombre";
  public static final String PROPERTY_ID = "Identificación";
  public static final String PROPERTY_CC = "C.C.";
  public static final String PROPERTY_LOCATION = "Localidad";
  public static final String PROPERTY_PARENT_ID = "Pariente ID";
  public static final String PROPERTY_INTEGER = "Entero";
  public static final String PROPERTY_TEXT = "Texto";
  public static final String PROPERTY_LONG = "Numérico";
  public static final String PROPERTY_PRICE = "Precio";
